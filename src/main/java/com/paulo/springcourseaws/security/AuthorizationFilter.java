...
import com.paulo.springcourseaws.constant.SecurityConstants;
import com.paulo.springcourseaws.resource.exception.ApiError;
...
public class AuthorizationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if( jwt == null || !jwt.startsWith(SecurityConstants.JWT_PROVIDER)) {
			ApiError apiError = new ApiError(HttpStatus.UNAUTHORIZED.value(), "Invalid jwt token", new Date());
